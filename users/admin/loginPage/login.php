...
<body style="background:linear-gradient(to right, #7F53AC, #647DEE)  !important;">
    ...
    <div class="container-fluid h-custom">
        ...
        <div class="col-md-9 col-lg-6 col-xl-5">
            <img src="../../img/logo.svg" class="img-fluid" alt="Sample image">
        </div>
        <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1" style="background-color:white; border-radius:15px; box-shadow: 1px 1px;">
            <form  method="post" action="" autocomplete="off">
                <div class="d-flex flex-row align-items-center justify-content-center justify-content-lg-start">
                    <p class="lead fw-normal mb-0 me-3"><b>Login Page for Admin</b></p>
                </div>
                ...
                <li class="nav-item" role="presentation">
                    ...
                    aria-controls="pills-login" aria-selected="true" class="btn_save_train"
                            style="background-color: #866ec7;
                                    ...
                                    font-size: 16px;">Admin</a>
                </li>
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="tab-register" data-mdb-toggle="pill" href="../../operator/loginPage/login.php" role="tab"
                    aria-controls="pills-register" aria-selected="false" style="background-color: #ece4fc; border-radius: 0 5px 5px 0; color:black">Operator</a>
                </li>
                </ul>
