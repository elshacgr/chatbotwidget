...
<body style="background:linear-gradient(to right, #7F53AC, #647DEE); max-width:100%; position:fix; overflow: -moz-scrollbars-horizontal; overflow-y: auto; overflow-x: hidden;">
    ...
    <center style="color: white; transform: translate(0%, 5%); font-size:50px;"><b>Guest House's Availability Room</b></center>
    <div class="container"  style="background:white; height:1850px; transform: translate(0%, 0%); border-radius:5px">
        <div style="height:50%">
            <table class="table table-bordered"  border="1" width="500" style="transform: translate(0%, 0%);">
                ...
                <tbody id="table-intent">
                    <?php
                        ...
                        $data = $db->retrieve("available/guest house");
